 ...
 */
/*
Plugin Name: Export Users to CSV [Modified]
...
class PP_EU_Export_Users {
	...
	public function generate_csv() {
		...
		if (is_admin() && isset( $_POST['_wpnonce-pp-eu-export-users-users-page_export'] ) ) {
			...
			// firsts lot out
			$this->get_users_data($users,$fields);
			unset($users);
			$continue = true;
			$i = $limit;
			while ($continue) {
	...
	private function get_users_data($users,$fields) {
